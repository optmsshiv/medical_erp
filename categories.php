...
<head>
  ...
  <style>
    ...
    .mf-cat-ico { width:auto; height:auto; background:transparent; border-radius:0; color:#16325c; display:inline-flex; align-items:center; justify-content:center; flex:0 0 auto; font-size:16px; line-height:1; }
      ...
      <main class="mf-main">
        ...
        <div class="card-mf mf-ledger">
          <div class="mf-ledger-search">
            ...
            <input id="catSearch" name="cat-list-filter" placeholder="Search category…" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" data-lpignore="true" data-1p-ignore="true">
          </div>
          ...
          <div class="mf-ledger-foot">
            ...
            <ul class="pagination pagination-sm mb-0" id="catPager"></ul>
          </div>
