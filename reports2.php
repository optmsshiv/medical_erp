    ...
    (function () {
      ...
      function renderProfit() {
        ...
        $('#rpProfitKpis').innerHTML = [
          ...
          ['Expenses', MF.fmt(k.expenses), 'warning', 'cash-coin'],
          ['Net Profit', MF.fmt(k.netProfit), k.netProfit >= 0 ? 'success' : 'danger', 'wallet2'],
        ].map(([l, v, tone, icon, delta]) => `
          <div class="col-lg-4 col-md-6"><div class="card-mf kpi-card h-100"><div class="kpi-icon tone-${tone}"><i class="bi bi-${icon}"></i></div>
