...
(function () {
    ...
    /* ---------- Reports: GST output summary (bar) ---------- */
    MFCharts.gstSummary = function (canvasId) {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return null;
        return new Chart(canvas, {
            type: 'bar',
            data: {
                ...
                datasets: [{
                    label: 'Tax amount',
                    data: [18420, 18420, 4260, 14680, 14680],
    ...
    MFCharts.profitTrend = function (canvasId) {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return null;
        return new Chart(canvas, {
            type: 'line',
            data: {
                ...
                datasets: [{
                    label: 'Gross Profit',
                    data: [31200, 35800, 44600, 27400, 33800, 39450, 42780],
