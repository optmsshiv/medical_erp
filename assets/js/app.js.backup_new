...
(function () {
  ...
  const NAV = [
    ...
    { label: 'Inventory', icon: 'boxes', items: [
      ...
      { label: 'Stock Overview', icon: 'box-seam', page: 'stock-overview', href: 'stock.php' },
      ...
      { label: 'Stock Adjustment', icon: 'sliders', page: 'stock-overview', href: 'stock.php?tab=adjustment' },
      { label: 'Stock Transfer', icon: 'arrow-left-right', page: 'stock-overview', href: 'stock.php?tab=transfer' }
    ]},
    {
